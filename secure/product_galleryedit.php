...
$product_gallery_edit = NULL; // Initialize page object first

class cproduct_gallery_edit extends cproduct_gallery {
	...
	// Page object name
	var $PageObjName = 'product_gallery_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_pro_gallery_id")) {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			if (!is_null($this->pro_gallery_id->CurrentValue) && !is_null($this->product_id->CurrentValue)) {
	...
	function RenderRow() {
		...
		$this->image->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->thumnail);
...
// Create page object
if (!isset($product_gallery_edit)) $product_gallery_edit = new cproduct_gallery_edit();

// Page init
$product_gallery_edit->Page_Init();

// Page main
$product_gallery_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$product_gallery_edit->Page_Render();
?>
...
var CurrentForm = fproduct_galleryedit = new ew_Form("fproduct_galleryedit", "edit");

// Validate form
fproduct_galleryedit.Validate = function() {
...
fproduct_galleryedit.Form_CustomValidate = 
...
fproduct_galleryedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproduct_galleryedit.Lists["x_product_id"] = {"LinkField":"x_product_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pro_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"products"};
fproduct_galleryedit.Lists["x_product_id"].Data = "<?php echo $product_gallery_edit->product_id->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $product_gallery_edit->ShowPageHeader(); ?>
<?php
...
<!--first page button-->
	<?php if ($product_gallery_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $product_gallery_edit->PageUrl() ?>start=<?php echo $product_gallery_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($product_gallery_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $product_gallery_edit->PageUrl() ?>start=<?php echo $product_gallery_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $product_gallery_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($product_gallery_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $product_gallery_edit->PageUrl() ?>start=<?php echo $product_gallery_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($product_gallery_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $product_gallery_edit->PageUrl() ?>start=<?php echo $product_gallery_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $product_gallery_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
...
<?php if ($product_gallery->thumnail->Visible) { // thumnail ?>
	<div id="r_thumnail" class="form-group">
		<label id="elh_product_gallery_thumnail" class="<?php echo $product_gallery_edit->LeftColumnClass ?>"><?php echo $product_gallery->thumnail->FldCaption() ?></label>
		<div class="<?php echo $product_gallery_edit->RightColumnClass ?>"><div<?php echo $product_gallery->thumnail->CellAttributes() ?>>
...
<?php if ($product_gallery->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_product_gallery_image" class="<?php echo $product_gallery_edit->LeftColumnClass ?>"><?php echo $product_gallery->image->FldCaption() ?></label>
		<div class="<?php echo $product_gallery_edit->RightColumnClass ?>"><div<?php echo $product_gallery->image->CellAttributes() ?>>
...
<script type="text/javascript">
fproduct_galleryedit.Init();
</script>
<?php
$product_gallery_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$product_gallery_edit->Page_Terminate();
?>
