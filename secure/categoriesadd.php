		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "categoriesview.php")
...
var CurrentForm = fcategoriesadd = new ew_Form("fcategoriesadd", "add");
...
fcategoriesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcategoriesadd.Lists["x_cat_home[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcategoriesadd.Lists["x_cat_home[]"].Options = <?php echo json_encode($categories_add->cat_home->Options()) ?>;
...
?>
<form name="fcategoriesadd" id="fcategoriesadd" class="<?php echo $categories_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
