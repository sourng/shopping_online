...
$model_addopt = NULL; // Initialize page object first

class cmodel_addopt extends cmodel {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_model_id"] = $this->model_id->DbValue;
...
// Create page object
if (!isset($model_addopt)) $model_addopt = new cmodel_addopt();

// Page init
$model_addopt->Page_Init();

// Page main
$model_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$model_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = fmodeladdopt = new ew_Form("fmodeladdopt", "addopt");

// Validate form
fmodeladdopt.Validate = function() {
...
fmodeladdopt.Form_CustomValidate = 
...
fmodeladdopt.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php
$model_addopt->ShowMessage();
?>
<form name="fmodeladdopt" id="fmodeladdopt" class="ewForm form-horizontal" action="modeladdopt.php" method="post">
<?php if ($model_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $model_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="model">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($model->name->Visible) { // name ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_name"><?php echo $model->name->FldCaption() ?></label>
		<div class="col-sm-10">
