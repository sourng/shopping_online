...
class cproducts_addopt extends cproducts {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_pro_model"] = ew_ConvertToUtf8($this->pro_model->DbValue);
					...
					$row["x_img1"] = ew_ConvertToUtf8($this->img1->DbValue);
					$row["x_img2"] = ew_ConvertToUtf8($this->img2->DbValue);
					$row["x_img3"] = ew_ConvertToUtf8($this->img3->DbValue);
					$row["x_img4"] = ew_ConvertToUtf8($this->img4->DbValue);
					$row["x_img5"] = ew_ConvertToUtf8($this->img5->DbValue);
	...
	function LoadFormValues() {
		...
		if (!$this->img1->FldIsDetailKey) {
			$this->img1->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_img1")));
		}
		if (!$this->img2->FldIsDetailKey) {
			$this->img2->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_img2")));
		}
		if (!$this->img3->FldIsDetailKey) {
			$this->img3->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_img3")));
		}
		if (!$this->img4->FldIsDetailKey) {
			$this->img4->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_img4")));
		}
		if (!$this->img5->FldIsDetailKey) {
			$this->img5->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_img5")));
		}
	...
	function RestoreFormValues() {
		...
		$this->img1->CurrentValue = ew_ConvertToUtf8($this->img1->FormValue);
		$this->img2->CurrentValue = ew_ConvertToUtf8($this->img2->FormValue);
		$this->img3->CurrentValue = ew_ConvertToUtf8($this->img3->FormValue);
		$this->img4->CurrentValue = ew_ConvertToUtf8($this->img4->FormValue);
		$this->img5->CurrentValue = ew_ConvertToUtf8($this->img5->FormValue);
...
<?php if ($products->pro_description->Visible) { // pro_description ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_pro_description"><?php echo $products->pro_description->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($products->img1->Visible) { // img1 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_img1"><?php echo $products->img1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($products->img2->Visible) { // img2 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_img2"><?php echo $products->img2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($products->img3->Visible) { // img3 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_img3"><?php echo $products->img3->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($products->img4->Visible) { // img4 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_img4"><?php echo $products->img4->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($products->img5->Visible) { // img5 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_img5"><?php echo $products->img5->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
