...
var CurrentForm = fprovinceview = new ew_Form("fprovinceview", "view");
...
fprovinceview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<?php if (!$province_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($province_view->Pager)) $province_view->Pager = new cPrevNextPager($province_view->StartRec, $province_view->DisplayRecs, $province_view->TotalRecs, $province_view->AutoHidePager) ?>
<?php if ($province_view->Pager->RecordCount > 0 && $province_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($province_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $province_view->PageUrl() ?>start=<?php echo $province_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($province_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $province_view->PageUrl() ?>start=<?php echo $province_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $province_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($province_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $province_view->PageUrl() ?>start=<?php echo $province_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($province_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $province_view->PageUrl() ?>start=<?php echo $province_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $province_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fprovinceview" id="fprovinceview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($province_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $province_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="province">
<input type="hidden" name="modal" value="<?php echo intval($province_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($province->province_id->Visible) { // province_id ?>
	<tr id="r_province_id">
		<td class="col-sm-2"><span id="elh_province_province_id"><?php echo $province->province_id->FldCaption() ?></span></td>
...
<?php echo $province->province_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->country_id->Visible) { // country_id ?>
	<tr id="r_country_id">
		<td class="col-sm-2"><span id="elh_province_country_id"><?php echo $province->country_id->FldCaption() ?></span></td>
...
<?php echo $province->country_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->province_name_kh->Visible) { // province_name_kh ?>
	<tr id="r_province_name_kh">
		<td class="col-sm-2"><span id="elh_province_province_name_kh"><?php echo $province->province_name_kh->FldCaption() ?></span></td>
...
<?php echo $province->province_name_kh->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->province_name_en->Visible) { // province_name_en ?>
	<tr id="r_province_name_en">
		<td class="col-sm-2"><span id="elh_province_province_name_en"><?php echo $province->province_name_en->FldCaption() ?></span></td>
...
<?php echo $province->province_name_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->capital_kh->Visible) { // capital_kh ?>
	<tr id="r_capital_kh">
		<td class="col-sm-2"><span id="elh_province_capital_kh"><?php echo $province->capital_kh->FldCaption() ?></span></td>
...
<?php echo $province->capital_kh->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->capital_en->Visible) { // capital_en ?>
	<tr id="r_capital_en">
		<td class="col-sm-2"><span id="elh_province_capital_en"><?php echo $province->capital_en->FldCaption() ?></span></td>
...
<?php echo $province->capital_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->population_kh->Visible) { // population_kh ?>
	<tr id="r_population_kh">
		<td class="col-sm-2"><span id="elh_province_population_kh"><?php echo $province->population_kh->FldCaption() ?></span></td>
...
<?php echo $province->population_kh->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->population_en->Visible) { // population_en ?>
	<tr id="r_population_en">
		<td class="col-sm-2"><span id="elh_province_population_en"><?php echo $province->population_en->FldCaption() ?></span></td>
...
<?php echo $province->population_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->area_kh->Visible) { // area_kh ?>
	<tr id="r_area_kh">
		<td class="col-sm-2"><span id="elh_province_area_kh"><?php echo $province->area_kh->FldCaption() ?></span></td>
...
<?php echo $province->area_kh->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->area_en->Visible) { // area_en ?>
	<tr id="r_area_en">
		<td class="col-sm-2"><span id="elh_province_area_en"><?php echo $province->area_en->FldCaption() ?></span></td>
...
<?php echo $province->area_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->density_kh->Visible) { // density_kh ?>
	<tr id="r_density_kh">
		<td class="col-sm-2"><span id="elh_province_density_kh"><?php echo $province->density_kh->FldCaption() ?></span></td>
...
<?php echo $province->density_kh->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->density_en->Visible) { // density_en ?>
	<tr id="r_density_en">
		<td class="col-sm-2"><span id="elh_province_density_en"><?php echo $province->density_en->FldCaption() ?></span></td>
...
<?php echo $province->density_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->province_code->Visible) { // province_code ?>
	<tr id="r_province_code">
		<td class="col-sm-2"><span id="elh_province_province_code"><?php echo $province->province_code->FldCaption() ?></span></td>
...
<?php echo $province->province_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($province->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_province_image"><?php echo $province->image->FldCaption() ?></span></td>
...
<?php echo $province->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
