...
<?php if ($model->name->Visible) { // name ?>
		<th class="<?php echo $model->name->HeaderCellClass() ?>"><span id="elh_model_name" class="model_name"><?php echo $model->name->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($model->name->Visible) { // name ?>
		<td<?php echo $model->name->CellAttributes() ?>>
<span id="el<?php echo $model_delete->RowCnt ?>_model_name" class="model_name">
