...
//
// Table class for langs
//
class clangs extends cTable {
	var $lang_id;
	var $lang_name_lable;
	var $english;
	var $khmer;
	...
	function __construct() {
		...
		// lang_id
		$this->lang_id = new cField('langs', 'langs', 'x_lang_id', 'lang_id', '`lang_id`', '`lang_id`', 3, -1, FALSE, '`lang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// lang_name_lable
		$this->lang_name_lable = new cField('langs', 'langs', 'x_lang_name_lable', 'lang_name_lable', '`lang_name_lable`', '`lang_name_lable`', 200, -1, FALSE, '`lang_name_lable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lang_name_lable->Sortable = TRUE; // Allow sort
		$this->fields['lang_name_lable'] = &$this->lang_name_lable;

		// english
		$this->english = new cField('langs', 'langs', 'x_english', 'english', '`english`', '`english`', 200, -1, FALSE, '`english`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->english->Sortable = TRUE; // Allow sort
		$this->fields['english'] = &$this->english;

		// khmer
		$this->khmer = new cField('langs', 'langs', 'x_khmer', 'khmer', '`khmer`', '`khmer`', 200, -1, FALSE, '`khmer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`langs`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "langsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "langsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("langsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("langsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "langsadd.php?" . $this->UrlParm($parm);
		else
			$url = "langsadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("langsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("langsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("langsdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->lang_name_lable->setDbValue($rs->fields('lang_name_lable'));
	...
	function RenderEditRow() {
		...
		$this->lang_name_lable->EditValue = $this->lang_name_lable->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->lang_name_lable->Exportable) $Doc->ExportCaption($this->lang_name_lable);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->lang_name_lable->Exportable) $Doc->ExportField($this->lang_name_lable);
