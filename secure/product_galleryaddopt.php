...
$product_gallery_addopt = NULL; // Initialize page object first

class cproduct_gallery_addopt extends cproduct_gallery {
	...
	// Page object name
	var $PageObjName = 'product_gallery_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_pro_gallery_id"] = $this->pro_gallery_id->DbValue;
					$row["x_product_id"] = $this->product_id->DbValue;
					$row["x_thumnail"] = ew_ConvertToUtf8($this->thumnail->DbValue);
	...
	function LoadFormValues() {
		...
		if (!$this->product_id->FldIsDetailKey) {
			$this->product_id->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_product_id")));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->product_id->CurrentValue = ew_ConvertToUtf8($this->product_id->FormValue);
	}
...
// Create page object
if (!isset($product_gallery_addopt)) $product_gallery_addopt = new cproduct_gallery_addopt();

// Page init
$product_gallery_addopt->Page_Init();

// Page main
$product_gallery_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$product_gallery_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = fproduct_galleryaddopt = new ew_Form("fproduct_galleryaddopt", "addopt");

// Validate form
fproduct_galleryaddopt.Validate = function() {
...
fproduct_galleryaddopt.Form_CustomValidate = 
...
fproduct_galleryaddopt.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproduct_galleryaddopt.Lists["x_product_id"] = {"LinkField":"x_product_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pro_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"products"};
fproduct_galleryaddopt.Lists["x_product_id"].Data = "<?php echo $product_gallery_addopt->product_id->LookupFilterQuery(FALSE, "addopt") ?>";
...
<?php
$product_gallery_addopt->ShowMessage();
?>
<form name="fproduct_galleryaddopt" id="fproduct_galleryaddopt" class="ewForm form-horizontal" action="product_galleryaddopt.php" method="post">
<?php if ($product_gallery_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $product_gallery_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="product_gallery">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($product_gallery->product_id->Visible) { // product_id ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_product_id"><?php echo $product_gallery->product_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($product_gallery->thumnail->Visible) { // thumnail ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel"><?php echo $product_gallery->thumnail->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($product_gallery->image->Visible) { // image ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel"><?php echo $product_gallery->image->FldCaption() ?></label>
		<div class="col-sm-10">
<div id="fd_x_image">
...
<?php
$product_gallery_addopt->Page_Terminate();
?>
