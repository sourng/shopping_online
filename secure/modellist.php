...
class cmodel_list extends cmodel {
	...
	function ClearInlineMode() {
		$this->setKey("model_id", ""); // Clear inline edit key
	...
	function InlineEditMode() {
		...
		if ($bInlineEdit) {
			if ($this->LoadRow()) {
				$this->setKey("model_id", $this->model_id->CurrentValue); // Set up inline edit key
	...
	function CheckInlineEditKey() {
		...
		if (strval($this->getKey("model_id")) <> strval($this->model_id->CurrentValue))
			return FALSE;
		return TRUE;
	}
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->model_id, $bCtrl); // model_id
	...
	function RenderListOptions() {
		...
		if ($this->CurrentAction == "edit" && $this->RowType == EW_ROWTYPE_EDIT) { // Inline-Edit
			...
			$oListOpt->Body .= "<input type=\"hidden\" name=\"k" . $this->RowIndex . "_key\" id=\"k" . $this->RowIndex . "_key\" value=\"" . ew_HtmlEncode($this->model_id->CurrentValue) . "\">";
			return;
		}
		...
		if ($Security->CanView()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewView\" title=\"" . $viewcaption . "\" data-table=\"model\" data-caption=\"" . $viewcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->ViewUrl) . "',btn:null});\">" . $Language->Phrase("ViewLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->CanEdit()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewEdit\" title=\"" . $editcaption . "\" data-table=\"model\" data-caption=\"" . $editcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'SaveBtn',url:'" . ew_HtmlEncode($this->EditUrl) . "'});\">" . $Language->Phrase("EditLink") . "</a>";
		...
		if ($Security->CanAdd()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewCopy\" title=\"" . $copycaption . "\" data-table=\"model\" data-caption=\"" . $copycaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'AddBtn',url:'" . ew_HtmlEncode($this->CopyUrl) . "'});\">" . $Language->Phrase("CopyLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
	...
	function SetupOtherOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<a class=\"ewAddEdit ewAdd\" title=\"" . $addcaption . "\" data-table=\"model\" data-caption=\"" . $addcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'AddBtn',url:'" . ew_HtmlEncode($this->AddUrl) . "'});\">" . $Language->Phrase("AddLink") . "</a>";
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewHighlight active\" title=\"" . $Language->Phrase("Highlight") . "\" data-caption=\"" . $Language->Phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fmodellistsrch\" data-name=\"" . $this->HighlightName() . "\">" . $Language->Phrase("HighlightBtn") . "</button>";
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a class=\"ewExportLink ewPrint\" title=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("PrinterFriendlyText")) . "\" onclick=\"ew_Export(document.fmodellist,'" . ew_CurrentPage() . "','print',false,true);\">" . $Language->Phrase("PrinterFriendly") . "</a>";
		$item->Visible = TRUE;

		// Export to Excel
		$item = &$this->ExportOptions->Add("excel");
		$item->Body = "<a class=\"ewExportLink ewExcel\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToExcelText")) . "\" onclick=\"ew_Export(document.fmodellist,'" . ew_CurrentPage() . "','excel',false,true);\">" . $Language->Phrase("ExportToExcel") . "</a>";
		$item->Visible = TRUE;

		// Export to Word
		$item = &$this->ExportOptions->Add("word");
		$item->Body = "<a class=\"ewExportLink ewWord\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToWordText")) . "\" onclick=\"ew_Export(document.fmodellist,'" . ew_CurrentPage() . "','word',false,true);\">" . $Language->Phrase("ExportToWord") . "</a>";
		$item->Visible = TRUE;

		// Export to Html
		$item = &$this->ExportOptions->Add("html");
		$item->Body = "<a class=\"ewExportLink ewHtml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToHtmlText")) . "\" onclick=\"ew_Export(document.fmodellist,'" . ew_CurrentPage() . "','html',false,true);\">" . $Language->Phrase("ExportToHtml") . "</a>";
		$item->Visible = TRUE;

		// Export to Xml
		$item = &$this->ExportOptions->Add("xml");
		$item->Body = "<a class=\"ewExportLink ewXml\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToXmlText")) . "\" onclick=\"ew_Export(document.fmodellist,'" . ew_CurrentPage() . "','xml',false,true);\">" . $Language->Phrase("ExportToXml") . "</a>";
		$item->Visible = FALSE;

		// Export to Csv
		$item = &$this->ExportOptions->Add("csv");
		$item->Body = "<a class=\"ewExportLink ewCsv\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToCsvText")) . "\" onclick=\"ew_Export(document.fmodellist,'" . ew_CurrentPage() . "','csv',false,true);\">" . $Language->Phrase("ExportToCsv") . "</a>";
		$item->Visible = TRUE;

		// Export to Pdf
		$item = &$this->ExportOptions->Add("pdf");
		$item->Body = "<a class=\"ewExportLink ewPdf\" title=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" data-caption=\"" . ew_HtmlEncode($Language->Phrase("ExportToPDFText")) . "\" onclick=\"ew_Export(document.fmodellist,'" . ew_CurrentPage() . "','pdf',false,true);\">" . $Language->Phrase("ExportToPDF") . "</a>";
		$item->Visible = FALSE;

		// Export to Email
		$item = &$this->ExportOptions->Add("email");
		$url = "";
		$item->Body = "<button id=\"emf_model\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_model',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fmodellist,sel:true" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Check empty row
fmodellist.EmptyRow = function(infix) {
	var fobj = this.Form;
...
if ($model->CurrentAction == "gridadd") {
	...
	$model_list->DisplayRecs = $model->GridAddRowCount;
	$model_list->TotalRecs = $model_list->DisplayRecs;
	$model_list->StopRec = $model_list->DisplayRecs;
} else {
...
<?php if ($model_list->TotalRecs > 0 || $model->CurrentAction == "add" || $model->CurrentAction == "copy" || $model->CurrentAction == "gridedit") { ?>
...
<?php if ($model->model_id->Visible) { // model_id ?>
	...
	<?php } else { ?>
		<th data-name="model_id" class="<?php echo $model->model_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->model_id) ?>',2);"><div id="elh_model_model_id" class="model_model_id">
...
<?php if ($model->name->Visible) { // name ?>
	<?php if ($model->SortUrl($model->name) == "") { ?>
		<th data-name="name" class="<?php echo $model->name->HeaderCellClass() ?>"><div id="elh_model_name" class="model_name"><div class="ewTableHeaderCaption"><?php echo $model->name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="name" class="<?php echo $model->name->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $model->SortUrl($model->name) ?>',2);"><div id="elh_model_name" class="model_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $model->name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($model->name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($model->name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<tbody>
<?php
	if ($model->CurrentAction == "add" || $model->CurrentAction == "copy") {
		$model_list->RowIndex = 0;
		$model_list->KeyCount = $model_list->RowIndex;
		if ($model->CurrentAction == "add")
			$model_list->LoadRowValues();
		if ($model->EventCancelled) // Insert failed
			$model_list->RestoreFormValues(); // Restore form values

		// Set row properties
		$model->ResetAttrs();
		$model->RowAttrs = array_merge($model->RowAttrs, array('data-rowindex'=>0, 'id'=>'r0_model', 'data-rowtype'=>EW_ROWTYPE_ADD));
...
<input type="hidden" data-table="model" data-field="x_model_id" name="o<?php echo $model_list->RowIndex ?>_model_id" id="o<?php echo $model_list->RowIndex ?>_model_id" value="<?php echo ew_HtmlEncode($model->model_id->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($model->name->Visible) { // name ?>
		<td data-name="name">
<span id="el<?php echo $model_list->RowCnt ?>_model_name" class="form-group model_name">
<input type="text" data-table="model" data-field="x_name" name="x<?php echo $model_list->RowIndex ?>_name" id="x<?php echo $model_list->RowIndex ?>_name" size="40" maxlength="250" placeholder="<?php echo ew_HtmlEncode($model->name->getPlaceHolder()) ?>" value="<?php echo $model->name->EditValue ?>"<?php echo $model->name->EditAttributes() ?>>
</span>
<input type="hidden" data-table="model" data-field="x_name" name="o<?php echo $model_list->RowIndex ?>_name" id="o<?php echo $model_list->RowIndex ?>_name" value="<?php echo ew_HtmlEncode($model->name->OldValue) ?>">
</td>
	<?php } ?>
<?php
...
?>
<script type="text/javascript">
fmodellist.UpdateOpts(<?php echo $model_list->RowIndex ?>);
</script>
	</tr>
<?php
}
...
if ($objForm) {
	$objForm->Index = -1;
	if ($objForm->HasValue($model_list->FormKeyCountName) && ($model->CurrentAction == "gridadd" || $model->CurrentAction == "gridedit" || $model->CurrentAction == "F")) {
		$model_list->KeyCount = $objForm->GetValue($model_list->FormKeyCountName);
		$model_list->StopRec = $model_list->StartRec + $model_list->KeyCount - 1;
	}
}
...
$model->ResetAttrs();
$model_list->RenderRow();
$model_list->EditRowCnt = 0;
if ($model->CurrentAction == "edit")
	$model_list->RowIndex = 1;
if ($model->CurrentAction == "gridadd")
	$model_list->RowIndex = 0;
...
while ($model_list->RecCnt < $model_list->StopRec) {
	...
	if (intval($model_list->RecCnt) >= intval($model_list->StartRec)) {
		...
		if ($model->CurrentAction == "gridadd" || $model->CurrentAction == "gridedit" || $model->CurrentAction == "F") {
			$model_list->RowIndex++;
			$objForm->Index = $model_list->RowIndex;
			if ($objForm->HasValue($model_list->FormActionName))
				$model_list->RowAction = strval($objForm->GetValue($model_list->FormActionName));
			elseif ($model->CurrentAction == "gridadd")
				$model_list->RowAction = "insert";
			else
				$model_list->RowAction = "";
		}
		...
		$model->CssClass = "";
		if ($model->CurrentAction == "gridadd") {
			$model_list->LoadRowValues(); // Load default values
		} else {
		...
		if ($model->CurrentAction == "gridadd" && $model->EventCancelled && !$objForm->HasValue("k_blankrow")) // Insert failed
			$model_list->RestoreCurrentRowFormValues($model_list->RowIndex); // Restore form values
		if ($model->CurrentAction == "edit") {
			if ($model_list->CheckInlineEditKey() && $model_list->EditRowCnt == 0) { // Inline edit
				$model->RowType = EW_ROWTYPE_EDIT; // Render edit
				if (!$model->EventCancelled)
					$model_list->HashValue = $model_list->GetRowHash($model_list->Recordset); // Get hash value for record
			}
		}
		if ($model->CurrentAction == "gridedit") { // Grid edit
			...
			if ($model_list->RowAction == "insert")
				$model->RowType = EW_ROWTYPE_ADD; // Render add
			else
				$model->RowType = EW_ROWTYPE_EDIT; // Render edit
			if (!$model->EventCancelled)
		...
		if ($model->CurrentAction == "edit" && $model->RowType == EW_ROWTYPE_EDIT && $model->EventCancelled) { // Update failed
			$objForm->Index = 1;
			$model_list->RestoreFormValues(); // Restore form values
		}
		...
		if ($model_list->RowAction <> "delete" && $model_list->RowAction <> "insertdelete" && !($model_list->RowAction == "insert" && $model->CurrentAction == "F" && $model_list->EmptyRow())) {
?>
	<tr<?php echo $model->RowAttributes() ?>>
<?php
...
<span id="el<?php echo $model_list->RowCnt ?>_model_model_id" class="form-group model_model_id">
<span<?php echo $model->model_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $model->model_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="model" data-field="x_model_id" name="x<?php echo $model_list->RowIndex ?>_model_id" id="x<?php echo $model_list->RowIndex ?>_model_id" value="<?php echo ew_HtmlEncode($model->model_id->CurrentValue) ?>">
<?php } ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($model->name->Visible) { // name ?>
		<td data-name="name"<?php echo $model->name->CellAttributes() ?>>
<?php if ($model->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $model_list->RowCnt ?>_model_name" class="form-group model_name">
<input type="text" data-table="model" data-field="x_name" name="x<?php echo $model_list->RowIndex ?>_name" id="x<?php echo $model_list->RowIndex ?>_name" size="40" maxlength="250" placeholder="<?php echo ew_HtmlEncode($model->name->getPlaceHolder()) ?>" value="<?php echo $model->name->EditValue ?>"<?php echo $model->name->EditAttributes() ?>>
</span>
...
<?php } ?>
<?php if ($model->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $model_list->RowCnt ?>_model_name" class="model_name">
<span<?php echo $model->name->ViewAttributes() ?>>
<?php echo $model->name->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<?php
	...
	if ($model->CurrentAction <> "gridadd")
		if (!$model_list->Recordset->EOF) $model_list->Recordset->MoveNext();
}
?>
<?php
	if ($model->CurrentAction == "gridadd" || $model->CurrentAction == "gridedit") {
		$model_list->RowIndex = '$rowindex$';
		$model_list->LoadRowValues();

		// Set row properties
		$model->ResetAttrs();
		$model->RowAttrs = array_merge($model->RowAttrs, array('data-rowindex'=>$model_list->RowIndex, 'id'=>'r0_model', 'data-rowtype'=>EW_ROWTYPE_ADD));
...
// Render list options (body, left)
$model_list->ListOptions->Render("body", "left", $model_list->RowIndex);
?>
	<?php if ($model->model_id->Visible) { // model_id ?>
		<td data-name="model_id">
<input type="hidden" data-table="model" data-field="x_model_id" name="o<?php echo $model_list->RowIndex ?>_model_id" id="o<?php echo $model_list->RowIndex ?>_model_id" value="<?php echo ew_HtmlEncode($model->model_id->OldValue) ?>">
	...
	<?php if ($model->name->Visible) { // name ?>
		<td data-name="name">
<span id="el$rowindex$_model_name" class="form-group model_name">
<input type="text" data-table="model" data-field="x_name" name="x<?php echo $model_list->RowIndex ?>_name" id="x<?php echo $model_list->RowIndex ?>_name" size="40" maxlength="250" placeholder="<?php echo ew_HtmlEncode($model->name->getPlaceHolder()) ?>" value="<?php echo $model->name->EditValue ?>"<?php echo $model->name->EditAttributes() ?>>
</span>
<input type="hidden" data-table="model" data-field="x_name" name="o<?php echo $model_list->RowIndex ?>_name" id="o<?php echo $model_list->RowIndex ?>_name" value="<?php echo ew_HtmlEncode($model->name->OldValue) ?>">
</td>
...
// Render list options (body, right)
$model_list->ListOptions->Render("body", "right", $model_list->RowIndex);
?>
<script type="text/javascript">
fmodellist.UpdateOpts(<?php echo $model_list->RowIndex ?>);
</script>
...
<?php } ?>
<?php if ($model->CurrentAction == "add" || $model->CurrentAction == "copy") { ?>
<input type="hidden" name="<?php echo $model_list->FormKeyCountName ?>" id="<?php echo $model_list->FormKeyCountName ?>" value="<?php echo $model_list->KeyCount ?>">
<?php } ?>
<?php if ($model->CurrentAction == "gridadd") { ?>
<input type="hidden" name="a_list" id="a_list" value="gridinsert">
<input type="hidden" name="<?php echo $model_list->FormKeyCountName ?>" id="<?php echo $model_list->FormKeyCountName ?>" value="<?php echo $model_list->KeyCount ?>">
<?php echo $model_list->MultiSelectKey ?>
<?php } ?>
<?php if ($model->CurrentAction == "edit") { ?>
<input type="hidden" name="<?php echo $model_list->FormKeyCountName ?>" id="<?php echo $model_list->FormKeyCountName ?>" value="<?php echo $model_list->KeyCount ?>">
<?php } ?>
<?php if ($model->CurrentAction == "gridedit") { ?>
