...
class ccountry_list extends ccountry {
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->country_name_kh); // country_name_kh
			$this->UpdateSort($this->country_name_en); // country_name_en
			$this->UpdateSort($this->country_code); // country_code
...
<?php if ($country->country_id->Visible) { // country_id ?>
	...
	<?php } else { ?>
		<th data-name="country_id" class="<?php echo $country->country_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->country_id) ?>',1);"><div id="elh_country_country_id" class="country_country_id">
...
<?php if ($country->country_name_kh->Visible) { // country_name_kh ?>
	...
	<?php } else { ?>
		<th data-name="country_name_kh" class="<?php echo $country->country_name_kh->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->country_name_kh) ?>',1);"><div id="elh_country_country_name_kh" class="country_country_name_kh">
...
<?php if ($country->country_name_en->Visible) { // country_name_en ?>
	...
	<?php } else { ?>
		<th data-name="country_name_en" class="<?php echo $country->country_name_en->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->country_name_en) ?>',1);"><div id="elh_country_country_name_en" class="country_country_name_en">
...
<?php if ($country->country_code->Visible) { // country_code ?>
	...
	<?php } else { ?>
		<th data-name="country_code" class="<?php echo $country->country_code->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->country_code) ?>',1);"><div id="elh_country_country_code" class="country_country_code">
...
<?php if ($country->image->Visible) { // image ?>
	...
	<?php } else { ?>
		<th data-name="image" class="<?php echo $country->image->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $country->SortUrl($country->image) ?>',1);"><div id="elh_country_image" class="country_image">
