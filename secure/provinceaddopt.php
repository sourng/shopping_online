...
$province_addopt = NULL; // Initialize page object first

class cprovince_addopt extends cprovince {
	...
	// Page object name
	var $PageObjName = 'province_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_province_name_kh"] = ew_ConvertToUtf8($this->province_name_kh->DbValue);
					$row["x_province_name_en"] = ew_ConvertToUtf8($this->province_name_en->DbValue);
					$row["x_capital_kh"] = ew_ConvertToUtf8($this->capital_kh->DbValue);
					$row["x_capital_en"] = ew_ConvertToUtf8($this->capital_en->DbValue);
					$row["x_population_kh"] = ew_ConvertToUtf8($this->population_kh->DbValue);
					$row["x_population_en"] = ew_ConvertToUtf8($this->population_en->DbValue);
					$row["x_area_kh"] = ew_ConvertToUtf8($this->area_kh->DbValue);
					$row["x_area_en"] = ew_ConvertToUtf8($this->area_en->DbValue);
					$row["x_density_kh"] = ew_ConvertToUtf8($this->density_kh->DbValue);
					$row["x_density_en"] = ew_ConvertToUtf8($this->density_en->DbValue);
					$row["x_province_code"] = ew_ConvertToUtf8($this->province_code->DbValue);
	...
	function LoadFormValues() {
		...
		if (!$this->province_name_kh->FldIsDetailKey) {
			$this->province_name_kh->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_province_name_kh")));
		}
		if (!$this->province_name_en->FldIsDetailKey) {
			$this->province_name_en->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_province_name_en")));
		}
		if (!$this->capital_kh->FldIsDetailKey) {
			$this->capital_kh->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_capital_kh")));
		}
		if (!$this->capital_en->FldIsDetailKey) {
			$this->capital_en->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_capital_en")));
		}
		if (!$this->population_kh->FldIsDetailKey) {
			$this->population_kh->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_population_kh")));
		}
		if (!$this->population_en->FldIsDetailKey) {
			$this->population_en->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_population_en")));
		}
		if (!$this->area_kh->FldIsDetailKey) {
			$this->area_kh->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_area_kh")));
		}
		if (!$this->area_en->FldIsDetailKey) {
			$this->area_en->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_area_en")));
		}
		if (!$this->density_kh->FldIsDetailKey) {
			$this->density_kh->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_density_kh")));
		}
		if (!$this->density_en->FldIsDetailKey) {
			$this->density_en->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_density_en")));
		}
		if (!$this->province_code->FldIsDetailKey) {
			$this->province_code->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_province_code")));
		}
	...
	function RestoreFormValues() {
		...
		$this->province_name_kh->CurrentValue = ew_ConvertToUtf8($this->province_name_kh->FormValue);
		$this->province_name_en->CurrentValue = ew_ConvertToUtf8($this->province_name_en->FormValue);
		$this->capital_kh->CurrentValue = ew_ConvertToUtf8($this->capital_kh->FormValue);
		$this->capital_en->CurrentValue = ew_ConvertToUtf8($this->capital_en->FormValue);
		$this->population_kh->CurrentValue = ew_ConvertToUtf8($this->population_kh->FormValue);
		$this->population_en->CurrentValue = ew_ConvertToUtf8($this->population_en->FormValue);
		$this->area_kh->CurrentValue = ew_ConvertToUtf8($this->area_kh->FormValue);
		$this->area_en->CurrentValue = ew_ConvertToUtf8($this->area_en->FormValue);
		$this->density_kh->CurrentValue = ew_ConvertToUtf8($this->density_kh->FormValue);
		$this->density_en->CurrentValue = ew_ConvertToUtf8($this->density_en->FormValue);
		$this->province_code->CurrentValue = ew_ConvertToUtf8($this->province_code->FormValue);
...
// Create page object
if (!isset($province_addopt)) $province_addopt = new cprovince_addopt();

// Page init
$province_addopt->Page_Init();

// Page main
$province_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$province_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = fprovinceaddopt = new ew_Form("fprovinceaddopt", "addopt");

// Validate form
fprovinceaddopt.Validate = function() {
...
fprovinceaddopt.Form_CustomValidate = 
...
fprovinceaddopt.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php
$province_addopt->ShowMessage();
?>
<form name="fprovinceaddopt" id="fprovinceaddopt" class="ewForm form-horizontal" action="provinceaddopt.php" method="post">
<?php if ($province_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $province_addopt->Token ?>">
<?php } ?>
...
<?php if ($province->country_id->Visible) { // country_id ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_country_id"><?php echo $province->country_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10">
...
<?php if ($province->province_name_kh->Visible) { // province_name_kh ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_province_name_kh"><?php echo $province->province_name_kh->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->province_name_en->Visible) { // province_name_en ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_province_name_en"><?php echo $province->province_name_en->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->capital_kh->Visible) { // capital_kh ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_capital_kh"><?php echo $province->capital_kh->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->capital_en->Visible) { // capital_en ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_capital_en"><?php echo $province->capital_en->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->population_kh->Visible) { // population_kh ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_population_kh"><?php echo $province->population_kh->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->population_en->Visible) { // population_en ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_population_en"><?php echo $province->population_en->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->area_kh->Visible) { // area_kh ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_area_kh"><?php echo $province->area_kh->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->area_en->Visible) { // area_en ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_area_en"><?php echo $province->area_en->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->density_kh->Visible) { // density_kh ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_density_kh"><?php echo $province->density_kh->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->density_en->Visible) { // density_en ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_density_en"><?php echo $province->density_en->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->province_code->Visible) { // province_code ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_province_code"><?php echo $province->province_code->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php if ($province->image->Visible) { // image ?>
	<div class="form-group">
		<label class="col-sm-2 control-label ewLabel" for="x_image"><?php echo $province->image->FldCaption() ?></label>
		<div class="col-sm-10">
...
<?php
$province_addopt->Page_Terminate();
?>
