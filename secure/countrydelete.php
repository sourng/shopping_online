	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("countrylist.php"); // Return to list
			}
		}
	}
...
fcountrydelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($country->country_id->Visible) { // country_id ?>
		<th class="<?php echo $country->country_id->HeaderCellClass() ?>"><span id="elh_country_country_id" class="country_country_id"><?php echo $country->country_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($country->country_name_kh->Visible) { // country_name_kh ?>
		<th class="<?php echo $country->country_name_kh->HeaderCellClass() ?>"><span id="elh_country_country_name_kh" class="country_country_name_kh"><?php echo $country->country_name_kh->FldCaption() ?></span></th>
<?php } ?>
<?php if ($country->country_name_en->Visible) { // country_name_en ?>
		<th class="<?php echo $country->country_name_en->HeaderCellClass() ?>"><span id="elh_country_country_name_en" class="country_country_name_en"><?php echo $country->country_name_en->FldCaption() ?></span></th>
<?php } ?>
<?php if ($country->country_code->Visible) { // country_code ?>
		<th class="<?php echo $country->country_code->HeaderCellClass() ?>"><span id="elh_country_country_code" class="country_country_code"><?php echo $country->country_code->FldCaption() ?></span></th>
<?php } ?>
<?php if ($country->image->Visible) { // image ?>
		<th class="<?php echo $country->image->HeaderCellClass() ?>"><span id="elh_country_image" class="country_image"><?php echo $country->image->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($country->country_id->Visible) { // country_id ?>
		<td<?php echo $country->country_id->CellAttributes() ?>>
<span id="el<?php echo $country_delete->RowCnt ?>_country_country_id" class="country_country_id">
...
<?php } ?>
<?php if ($country->country_name_kh->Visible) { // country_name_kh ?>
		<td<?php echo $country->country_name_kh->CellAttributes() ?>>
<span id="el<?php echo $country_delete->RowCnt ?>_country_country_name_kh" class="country_country_name_kh">
...
<?php } ?>
<?php if ($country->country_name_en->Visible) { // country_name_en ?>
		<td<?php echo $country->country_name_en->CellAttributes() ?>>
<span id="el<?php echo $country_delete->RowCnt ?>_country_country_name_en" class="country_country_name_en">
...
<?php } ?>
<?php if ($country->country_code->Visible) { // country_code ?>
		<td<?php echo $country->country_code->CellAttributes() ?>>
<span id="el<?php echo $country_delete->RowCnt ?>_country_country_code" class="country_country_code">
...
<?php } ?>
<?php if ($country->image->Visible) { // image ?>
		<td<?php echo $country->image->CellAttributes() ?>>
<span id="el<?php echo $country_delete->RowCnt ?>_country_image" class="country_image">
