...
fcountryview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if (!isset($country_view->Pager)) $country_view->Pager = new cPrevNextPager($country_view->StartRec, $country_view->DisplayRecs, $country_view->TotalRecs, $country_view->AutoHidePager) ?>
<?php if ($country_view->Pager->RecordCount > 0 && $country_view->Pager->Visible) { ?>
<div class="ewPager">
...
<input type="hidden" name="modal" value="<?php echo intval($country_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($country->country_id->Visible) { // country_id ?>
	<tr id="r_country_id">
		<td class="col-sm-2"><span id="elh_country_country_id"><?php echo $country->country_id->FldCaption() ?></span></td>
...
<?php echo $country->country_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($country->country_name_kh->Visible) { // country_name_kh ?>
	<tr id="r_country_name_kh">
		<td class="col-sm-2"><span id="elh_country_country_name_kh"><?php echo $country->country_name_kh->FldCaption() ?></span></td>
...
<?php echo $country->country_name_kh->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($country->country_name_en->Visible) { // country_name_en ?>
	<tr id="r_country_name_en">
		<td class="col-sm-2"><span id="elh_country_country_name_en"><?php echo $country->country_name_en->FldCaption() ?></span></td>
...
<?php echo $country->country_name_en->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($country->country_code->Visible) { // country_code ?>
	<tr id="r_country_code">
		<td class="col-sm-2"><span id="elh_country_country_code"><?php echo $country->country_code->FldCaption() ?></span></td>
...
<?php echo $country->country_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($country->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_country_image"><?php echo $country->image->FldCaption() ?></span></td>
...
<?php echo $country->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($country->deatil->Visible) { // deatil ?>
	<tr id="r_deatil">
		<td class="col-sm-2"><span id="elh_country_deatil"><?php echo $country->deatil->FldCaption() ?></span></td>
		<td data-name="deatil"<?php echo $country->deatil->CellAttributes() ?>>
<span id="el_country_deatil">
<span<?php echo $country->deatil->ViewAttributes() ?>>
<?php echo $country->deatil->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
