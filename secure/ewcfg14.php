...
define("EW_PROJECT_NAME", "ShoppingOnline", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'B4jU2FrqKcpwHRiD', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "shopping_online", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`company`", TRUE);
define("EW_USER_NAME_FILTER", "(`com_email` = '%u')", TRUE);
