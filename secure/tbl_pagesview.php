...
$tbl_pages_view = NULL; // Initialize page object first

class ctbl_pages_view extends ctbl_pages {
	...
	// Page object name
	var $PageObjName = 'tbl_pages_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["page_id"] <> "") {
			$this->RecKey["page_id"] = $_GET["page_id"];
			$KeyUrl .= "&amp;page_id=" . urlencode($this->RecKey["page_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["page_id"] <> "") {
				...
				$this->RecKey["page_id"] = $this->page_id->QueryStringValue;
			} elseif (@$_POST["page_id"] <> "") {
				$this->page_id->setFormValue($_POST["page_id"]);
				$this->RecKey["page_id"] = $this->page_id->FormValue;
			} else {
				...
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->page_id->CurrentValue) == strval($this->Recordset->fields('page_id'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "tbl_pageslist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "tbl_pageslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tbl_pages_view)) $tbl_pages_view = new ctbl_pages_view();

// Page init
$tbl_pages_view->Page_Init();

// Page main
$tbl_pages_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_pages_view->Page_Render();
?>
...
var CurrentForm = ftbl_pagesview = new ew_Form("ftbl_pagesview", "view");

// Form_CustomValidate event
ftbl_pagesview.Form_CustomValidate = 
...
ftbl_pagesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $tbl_pages_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tbl_pages_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $tbl_pages_view->ShowPageHeader(); ?>
<?php
$tbl_pages_view->ShowMessage();
?>
<?php if (!$tbl_pages_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($tbl_pages_view->Pager)) $tbl_pages_view->Pager = new cPrevNextPager($tbl_pages_view->StartRec, $tbl_pages_view->DisplayRecs, $tbl_pages_view->TotalRecs, $tbl_pages_view->AutoHidePager) ?>
<?php if ($tbl_pages_view->Pager->RecordCount > 0 && $tbl_pages_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($tbl_pages_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $tbl_pages_view->PageUrl() ?>start=<?php echo $tbl_pages_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($tbl_pages_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $tbl_pages_view->PageUrl() ?>start=<?php echo $tbl_pages_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $tbl_pages_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($tbl_pages_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $tbl_pages_view->PageUrl() ?>start=<?php echo $tbl_pages_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($tbl_pages_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $tbl_pages_view->PageUrl() ?>start=<?php echo $tbl_pages_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $tbl_pages_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ftbl_pagesview" id="ftbl_pagesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_pages_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_pages_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_pages">
<input type="hidden" name="modal" value="<?php echo intval($tbl_pages_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($tbl_pages->page_id->Visible) { // page_id ?>
	<tr id="r_page_id">
		<td class="col-sm-2"><span id="elh_tbl_pages_page_id"><?php echo $tbl_pages->page_id->FldCaption() ?></span></td>
...
<?php echo $tbl_pages->page_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_pages->page_name->Visible) { // page_name ?>
	<tr id="r_page_name">
		<td class="col-sm-2"><span id="elh_tbl_pages_page_name"><?php echo $tbl_pages->page_name->FldCaption() ?></span></td>
...
<?php echo $tbl_pages->page_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_pages->page_title->Visible) { // page_title ?>
	<tr id="r_page_title">
		<td class="col-sm-2"><span id="elh_tbl_pages_page_title"><?php echo $tbl_pages->page_title->FldCaption() ?></span></td>
...
<?php echo $tbl_pages->page_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_pages->page_url->Visible) { // page_url ?>
	<tr id="r_page_url">
		<td class="col-sm-2"><span id="elh_tbl_pages_page_url"><?php echo $tbl_pages->page_url->FldCaption() ?></span></td>
...
<?php echo $tbl_pages->page_url->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_pages->page_description->Visible) { // page_description ?>
	<tr id="r_page_description">
		<td class="col-sm-2"><span id="elh_tbl_pages_page_description"><?php echo $tbl_pages->page_description->FldCaption() ?></span></td>
...
<?php echo $tbl_pages->page_description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_pages->page_detail->Visible) { // page_detail ?>
	<tr id="r_page_detail">
		<td class="col-sm-2"><span id="elh_tbl_pages_page_detail"><?php echo $tbl_pages->page_detail->FldCaption() ?></span></td>
		<td data-name="page_detail"<?php echo $tbl_pages->page_detail->CellAttributes() ?>>
<span id="el_tbl_pages_page_detail">
<span<?php echo $tbl_pages->page_detail->ViewAttributes() ?>>
<?php echo $tbl_pages->page_detail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_pages->page_icon->Visible) { // page_icon ?>
	<tr id="r_page_icon">
		<td class="col-sm-2"><span id="elh_tbl_pages_page_icon"><?php echo $tbl_pages->page_icon->FldCaption() ?></span></td>
...
<?php echo $tbl_pages->page_icon->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_pages->lang->Visible) { // lang ?>
	<tr id="r_lang">
		<td class="col-sm-2"><span id="elh_tbl_pages_lang"><?php echo $tbl_pages->lang->FldCaption() ?></span></td>
...
<?php echo $tbl_pages->lang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
