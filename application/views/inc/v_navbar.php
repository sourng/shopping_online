						...
						?>	
							...
							<li class="active dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Pages <span class="caret"></span></a>
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo site_url(); ?>profile/my_ads">My Ads</a></li>
									<li><a href="<?php echo site_url(); ?>profile/index">My Profile</a></li>
									<li><a href="<?php echo site_url(); ?>profile/favourite_ads">Favourite Ads</a></li>
									<li><a href="<?php echo site_url(); ?>profile/archived_ads">Archived Ads</a></li>
									<li><a href="<?php echo site_url(); ?>profile/pending_ads">Pending Ads</a></li>
									<li><a href="<?php echo site_url(); ?>profile/delete_account">Close Account</a></li>
